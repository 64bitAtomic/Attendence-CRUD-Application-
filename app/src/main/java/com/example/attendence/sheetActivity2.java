...
public class sheetActivity2 extends AppCompatActivity {
    ...
    private void showTable() {
        ...
        TableRow[] row = new TableRow[rowSize];
        ...
        for (int i = 0; i  < rowSize ; i++) {
            ...
            if(i%2==0){
                ...
                row[i].setBackgroundColor(Color.parseColor("#E4E4E4"));
