...
public class StudentActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        while(cursor.moveToNext()){
            int _sid = cursor.getColumnIndex(DbHelper.S_ID);
            int _roll = cursor.getColumnIndex(DbHelper.STUDENT_ROLL_KEY);
            int _name = cursor.getColumnIndex(DbHelper.STUDENT_NAME_KEY);
            long sid = cursor.getLong(_sid);
            int roll = cursor.getInt(_roll);
    ...
    private void showCalender() {
        ...
        calender.setOnCalenderOkClickListener(this::onCalenderClicked);
    }
    ...
    private void addStudent(String roll_string, String name) {
        ...
        StudentItem studentIteme = new StudentItem(sid,roll,name);
        studentItems.add(studentIteme);
        adapter.notifyDataSetChanged();
    }
    ...
    private void deleteStudent(int position) {
        ...
        dbHelper.deleteStudent((int) studentItems.get(position).getSid());
